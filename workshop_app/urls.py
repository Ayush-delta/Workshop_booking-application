...
urlpatterns = [
    ...
    re_path(r'^status$', views.workshop_status_coordinator, name='workshop_status_coordinator'),
    re_path(r'^dashboard$', views.workshop_status_instructor, name='workshop_status_instructor'),
    ...
    re_path(r'^propose/$', views.propose_workshop, name='propose_workshop'),
    re_path(r'^add_workshop_type$', views.add_workshop_type, name='add_workshop_type'),
    re_path(r'^delete_attachment_file/(?P<file_id>\d+)$', views.delete_attachment_file, name='delete_attachment_file'),
    re_path(r'^types/$', views.workshop_type_list, name='workshop_type_list'),
    re_path(r'^view_profile/$', views.view_own_profile, name='view_own_profile'),
